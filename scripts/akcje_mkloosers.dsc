...
# $dir = ["08OCTAVA", "AGORA", "ALIOR", "ATREM", "ATLANTAPL", "COLIAN", "DECORA", "EDINVEST", "ENERGA", "ESSYSTEM", "GETIN", "GETINOBLE", "GPW", "INDYKPOL", "IPOPEMA", "LIBET", "MOSTALPLC", "NOWAGALA", "ORANGEPL", "ORZBIALY", "OTMUCHOW", "PEPEES", "PGE", "PKOBP", "PROCAD", "PROJPRZEM", "PROTEKTOR", "PZU", "RELPOL", "SOLAR", "TAURONPE", "TESGAS", "TORPOL", "TRAKCJA", "UNIMA", "WADEX"]

$dir = ["ATLANTAPL", "ATREM", "COLIAN", "ESSYSTEM", "INDYKPOL", "IPOPEMA", "LIBET", "ORANGEPL", "OTMUCHOW", "PEKAO", "PROCAD", "RELPOL", "SOLAR", "TESGAS", "TRITON", "WADEX"]
